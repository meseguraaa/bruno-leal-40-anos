    ...
    363: (e, t, r) => {
      ...
      async function z(e = {}) {
        ...
        if (
          ...
          (o = (0, A.getURL)()),
          (0, U.hasBasePath)(o) && (o = (0, D.removeBasePath)(o)),
          a.scriptLoader)
        ) {
      ...
      let K = (e) => (t) => {
        ...
        return (0, y.jsx)(V, { children: Y(e, r) });
      };
      function Q(e) {
        let { App: t, err: u } = e;
        return (
            ...
            (0, y.jsxs)(V, {
              children: [
                ...
                (0, y.jsx)(w.Portal, {
                  ...
                  children: (0, y.jsx)(I.RouteAnnouncer, {}),
                }),
              ],
            }),
          ],
          ...
          return function e(t, r) {
            ...
            for (let c of u) {
              ...
              if (u) {
                ...
                if ((l.push(u), u.interceptionMarker)) {
        ...
        for (; l.length > 0; ) {
          ...
          if (
            ...
            let { paramName: e, paramType: r } = d.param,
              n = (0, s.resolveParamValue)(e, r, t, c, a);
            if (void 0 !== n) a[e] = n;
          ...
          case "catchall-intercepted-(...)":
            ...
            throw Object.defineProperty(
              new n.InvariantError(
                `Unexpected empty path segments match for a route "${o.pathname}" with param "${e}" of type "${t}"`,
              ),
              "__NEXT_ERROR_CODE",
    ...
    8762: (e, t, r) => {
      ...
      class K {
        ...
        async change(e, t, r, n, a) {
          let o, i;
          if (!(0, N.isLocalURL)(t)) return (Y({ url: t, router: this }), !1);
          let f = 1 === n._h;
          ...
          let { shallow: w = !1, scroll: I = !0 } = n,
            L = { shallow: w };
          (this._inFlightRoute &&
            this.clc &&
            (j ||
              K.events.emit("routeChangeError", $(), this._inFlightRoute, L),
            this.clc(),
            (this.clc = null)),
            (r = (0, O.addBasePath)(
              (0, P.addLocale)(
          ...
          let U = A !== p.locale;
          if (!f && this.onlyAHashChange(D) && !U) {
            ((p.asPath = D),
              K.events.emit("hashChangeStart", r, L),
            ...
            try {
              ...
              throw (
                (0, c.default)(e) &&
                  e.cancelled &&
                  K.events.emit("routeChangeError", e, D, L),
                e
              );
            }
            return (K.events.emit("hashChangeComplete", r, L), !0);
          }
          let k = (0, m.parseRelativeUrl)(t),
            { pathname: W, query: G } = k;
          try {
          ...
          this.urlIsNew(D) || U || (e = "replaceState");
          let q = r;
          W = W ? (0, u.removeTrailingSlash)((0, v.removeBasePath)(W)) : W;
          let z = (0, u.removeTrailingSlash)(W),
          ...
          let Q = !!(
              ...
              (!(0, _.isDynamicRoute)(z) ||
                !(0, g.getRouteMatcher)((0, E.getRouteRegex)(z))(V))
            ),
            J =
              !n.shallow &&
              (await F({ asPath: r, locale: p.locale, router: this }));
          if (
            (f && J && (d = !1),
            d &&
              "/_error" !== W &&
              ...
              k.pathname !== W &&
                ((W = k.pathname),
                (k.pathname = (0, O.addBasePath)(W)),
                J || (t = (0, y.formatWithValidation)(k)))),
            !(0, N.isLocalURL)(r))
          )
            return (Y({ url: r, router: this }), !1);
          ((q = (0, R.removeLocale)((0, v.removeBasePath)(q), p.locale)),
            (z = (0, u.removeTrailingSlash)(W)));
          let Z = !1;
          if ((0, _.isDynamicRoute)(z)) {
            let e = (0, m.parseRelativeUrl)(q),
              n = e.pathname,
              a = (0, E.getRouteRegex)(z);
            Z = (0, g.getRouteMatcher)(a)(n);
            let o = z === n,
              i = o ? (0, M.interpolateAs)(z, n, G) : {};
            if (Z && (!o || i.result))
              o
                ? (r = (0, y.formatWithValidation)(
                    Object.assign({}, e, {
                      pathname: i.result,
                      query: (0, C.omit)(G, i.params),
                    }),
                  ))
                : Object.assign(G, Z);
            else {
          ...
          f || K.events.emit("routeChangeStart", r, L);
          ...
          try {
            ...
            if (
              ...
              let e = (0, S.hasBasePath)(k.pathname)
                ? (0, v.removeBasePath)(k.pathname)
                : k.pathname;
              if (
                (Z &&
                  W !== e &&
            ...
            if ("type" in i)
              if ("redirect-internal" === i.type)
                ...
                return (
                  Y({ url: i.destination, router: this }),
                  new Promise(() => {})
                );
            let u = i.Component;
            if (
              ...
              if (i.props.pageProps && i.props.pageProps.__N_REDIRECT) {
                ...
                if (
                  ...
                  r.pathname = H(r.pathname, o);
                  let { url: a, as: i } = B(this, t, t);
                  return this.change(e, a, i, n);
                }
                return (Y({ url: t, router: this }), new Promise(() => {}));
              }
              if (
                ((p.isPreview = !!i.props.__N_PREVIEW), i.props.notFound === X)
              ) {
                let e;
                try {
            ...
            let s = n.shallow && p.route === (i.route ?? z),
              d = n.scroll ?? (!f && !s),
              h = a ?? (d ? { x: 0, y: 0 } : null),
              y = {
                ...p,
            ...
            if (
              (K.events.emit("beforeHistoryChange", r, L),
              ...
              if (i.error)
                throw (
                  f || K.events.emit("routeChangeError", i.error, D, L),
                  i.error
                );
              (f || K.events.emit("routeChangeComplete", r, L),
