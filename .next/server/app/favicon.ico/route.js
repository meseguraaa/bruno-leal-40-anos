  ...
  ((a.id = 230),
    ...
    (a.modules = {
      ...
      240: (a, b, c) => {
        ...
        let g = (d = c(2399)) && d.__esModule ? d : { default: d };
        function h(a) {
            ...
            226: function (e, f) {
              !(function (g, h) {
                ...
                var i = "function",
                  ...
                  Y = function (a, b) {
                    for (var c, d, e, f, g, h, j = 0; j < b.length && !g; ) {
                      var l = b[j],
                        m = b[j + 1];
                              ...
                              typeof (f = m[e]) === k && f.length > 0
                                ? 2 === f.length
                                  ...
                                  : 3 === f.length
                                    ...
                                    : 4 === f.length &&
                                      (this[f[0]] = h
                                        ? f[3].call(this, h.replace(f[1], f[2]))
                                        : void 0)
                                : (this[f] = h || void 0));
                      j += 2;
                    }
                    ...
                    for (var c in b)
                      if (typeof b[c] === k && b[c].length > 0) {
                        for (var d = 0; d < b[c].length; d++)
                          if (V(b[c][d], a)) return "?" === c ? void 0 : c;
                      } else if (V(b[c], a)) return "?" === c ? void 0 : c;
                    return a;
                  },
                  $ = {
                    ME: "4.90",
                  ...
                  aa = function (a, b) {
                    if (
                      (typeof a === k && ((b = a), (a = void 0)),
                      !(this instanceof aa))
                    )
                      return new aa(a, b).getResult();
                    var c =
                        typeof g !== j && g.navigator ? g.navigator : void 0,
                      d = a || (c && c.userAgent ? c.userAgent : ""),
                      e = c && c.userAgentData ? c.userAgentData : void 0,
                      f = b ? T(_, b) : _,
                      h = c && c.userAgent == d;
                    return (
                      ...
                      (this.getCPU = function () {
                        var a = {};
                        return ((a[s] = void 0), Y.call(a, d, f.cpu), a);
                      }),
      ...
      9706: (a, b, c) => {
        ...
        let z = "force-static",
          A = new e.AppRouteRouteModule({
            ...
            relativeProjectDir: "",
            resolvedPagePath:
              "next-metadata-route-loader?filePath=%2FUsers%2Fbrunoleal%2FDocuments%2FSite%2Fsrc%2Fapp%2Ffavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__",
            nextConfigOutput: "",
            userland: d,
          }),
        ...
        async function F(a, b, c) {
          ...
          "/index" === d && (d = "/");
          let e = await A.prepare(a, b, { srcPage: d, multiZoneDraftMode: !1 });
          if (!e)
            return (
              (b.statusCode = 400),
              b.end("Bad Request"),
          ...
          if (J && !z) {
            ...
            if (b && !1 === b.fallback && !a) {
              ...
              throw new u.NoFallbackError();
            }
          }
          let L = null;
          !J || A.isDev || z || (L = "/index" === (L = F) ? "/" : L);
          let M = !0 === A.isDev || !J,
            N = J && !M;
          H &&
            G &&
            (0, j.setReferenceManifestsSingleton)({
              page: d,
              clientReferenceManifest: G,
              serverActionsManifest: H,
              serverModuleMap: (0, k.createServerModuleMap)({
                serverActionsManifest: H,
              }),
            });
          let O = a.method || "GET",
            ...
            R = {
              ...
              renderOpts: {
                ...
                onInstrumentationRequestError: (b, c, d) =>
                  A.onRequestError(a, b, d, C),
              },
              sharedContext: { buildId: g },
            },
            S = new m.NodeNextRequest(a),
            T = new m.NodeNextResponse(b),
            U = n.NextRequestAdapter.fromNodeNextRequest(
              S,
              (0, n.signalFromNodeResponse)(b),
            );
          try {
            let e = async (a) =>
                A.handle(U, R).finally(() => {
                  if (!a) return;
                  a.setAttributes({
                  ...
                  if (!c) return;
                  if (
                    c.get("next.span_type") !== o.BaseServerSpan.handleRequest
                  )
              ...
              g = !!(0, h.getRequestMeta)(a, "minimalMode"),
              j = async (h) => {
                var i, j;
                      ...
                      if (!J)
                        return (
                          await (0, q.I)(
                            ...
                            T,
                            d,
                            R.renderOpts.pendingWaitUntil,
                          ),
                          null
                        );
                      {
                        let a = await d.blob(),
                          b = (0, r.toNodeOutgoingHttpHeaders)(d.headers);
                        (j && (b[t.NEXT_CACHE_TAGS_HEADER] = j),
                          !b["content-type"] &&
                            a.type &&
                            (b["content-type"] = a.type));
                        let c =
                            void 0 !== R.renderOpts.collectedRevalidate &&
                            !(
                              R.renderOpts.collectedRevalidate >=
                              t.INFINITE_CACHE
                            ) &&
                            R.renderOpts.collectedRevalidate,
                          e =
                            void 0 === R.renderOpts.collectedExpire ||
                            R.renderOpts.collectedExpire >= t.INFINITE_CACHE
                              ? void 0
                              : R.renderOpts.collectedExpire;
                        return {
                          value: {
                ...
                let m = (0, r.fromNodeOutgoingHttpHeaders)(l.value.headers);
                return (
                  (g && J) || m.delete(t.NEXT_CACHE_TAGS_HEADER),
                  !l.cacheControl ||
                    b.getHeader("Cache-Control") ||
                    m.get("Cache-Control") ||
                    m.set(
                      "Cache-Control",
                      (0, s.getCacheControlHeader)(l.cacheControl),
                    ),
                  await (0, q.I)(
                    S,
                    T,
            ...
            Q
              ? await j(Q)
              : await P.withPropagatedContext(a.headers, () =>
                  P.trace(
            ...
            if (
              (b instanceof u.NoFallbackError ||
              ...
              throw b;
            return (
              await (0, q.I)(S, T, new Response(null, { status: 500 })),
              null
            );
          }
        }
