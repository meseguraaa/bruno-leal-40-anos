    ...
    (a.modules = {
      ...
      9706: (a, b, c) => {
        ...
        async function E(a, b, c) {
          ...
          "/index" === d && (d = "/");
          let e = await z.prepare(a, b, { srcPage: d, multiZoneDraftMode: !1 });
          if (!e)
            return (
              (b.statusCode = 400),
              b.end("Bad Request"),
          ...
          let {
            ...
            H = (0, k.normalizeAppPath)(d),
            I = !!(A.dynamicRoutes[H] || A.routes[E]),
            J = async () => (
              (null == B ? void 0 : B.render404)
                ? await B.render404(a, b, x, !1)
          ...
          if (I && !y) {
            let a = !!A.routes[E],
              b = A.dynamicRoutes[H];
            if (b && !1 === b.fallback && !a) {
              if (w.experimental.adapterPath) return await J();
              throw new t.NoFallbackError();
            }
          }
          let K = null;
          !I || z.isDev || y || (K = "/index" === (K = E) ? "/" : K);
          let L = !0 === z.isDev || !I,
            M = I && !L;
          G &&
            F &&
            ...
            Q = {
              ...
              renderOpts: {
                ...
                onInstrumentationRequestError: (b, c, d, e) =>
                  z.onRequestError(a, b, d, e, B),
              },
              sharedContext: { buildId: g },
            },
            R = new l.NodeNextRequest(a),
            S = new l.NodeNextResponse(b),
            T = m.NextRequestAdapter.fromNodeNextRequest(
              R,
              (0, m.signalFromNodeResponse)(b),
            );
          try {
            let e = async (a) =>
                z.handle(T, Q).finally(() => {
                  if (!a) return;
                  a.setAttributes({
              ...
              j = async (h) => {
                        ...
                        );
                      {
                        ...
                        let c =
                          ...
                          e =
                            ...
                            Q.renderOpts.collectedExpire >= s.INFINITE_CACHE
                              ? void 0
                ...
                let m = (0, q.fromNodeOutgoingHttpHeaders)(l.value.headers);
                return (
                  (g && I) || m.delete(s.NEXT_CACHE_TAGS_HEADER),
                  !l.cacheControl ||
                    b.getHeader("Cache-Control") ||
                    m.get("Cache-Control") ||
                    m.set(
                      "Cache-Control",
                      (0, r.getCacheControlHeader)(l.cacheControl),
                    ),
                  await (0, p.I)(
                    R,
                    S,
            ...
            if (
              ...
              throw b;
            return (
              await (0, p.I)(R, S, new Response(null, { status: 500 })),
              null
            );
          }
        }
