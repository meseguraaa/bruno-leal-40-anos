  ...
  `);
    ...
    8575: (a, b, c) => {
      ...
      let f = c(6796),
        ...
        h = c(203),
        i = c(9294);
      function j({ serverActionsManifest: a }) {
        return new Proxy(
          {},
          {
            get: (b, c) => {
              ...
              if (!(f = h ? g[l(h.page)] : Object.values(g).at(0))) return;
              let { moduleId: j, async: k } = f;
      ...
      function k(a, b, c) {
        var d, e;
        let g = null == (d = c.node[a]) ? void 0 : d.workers,
          i = l(b);
        if (g && !g[i]) {
          return (
            (e = Object.keys(g)[0]),
            (0, f.normalizeAppPath)((0, h.removePathPrefix)(e, "app"))
          );
        }
      }
      function l(a) {
        return (0, g.pathHasPrefix)(a, "app") ? a : "app" + a;
      }
    },
    8863: (a, b, c) => {
      "use strict";
